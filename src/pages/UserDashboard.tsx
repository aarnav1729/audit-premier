...
export const UserDashboard: React.FC = () => {
  ...
  const userIssues = auditIssues.filter(issue => issue.personResponsible === user?.email);
  ...
  const handleEvidenceUpload = (evidence: Evidence[], textEvidence?: string) => {
    ...
    <div className="flex space-x-2 items-center">
      ...
      {issue.reviewComments && (
        <div className="max-w-xs">
          <p className="text-xs text-gray-600 italic" title={issue.reviewComments}>
    ...
    <div className="container mx-auto p-6 space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600 mt-1">Manage your assigned audit issues</p>
        </div>
